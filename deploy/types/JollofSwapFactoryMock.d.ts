...
interface JollofSwapFactoryMockInterface extends ethers.utils.Interface {
  functions: {
...
export class JollofSwapFactoryMock extends Contract {
  ...
  interface: JollofSwapFactoryMockInterface;
