...
interface JollofSwapPairMockInterface extends ethers.utils.Interface {
  functions: {
...
export class JollofSwapPairMock extends Contract {
  ...
  interface: JollofSwapPairMockInterface;
