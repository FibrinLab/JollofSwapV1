...
interface JollofMakerInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "shed", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "shed", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export class JollofMaker extends Contract {
  ...
  interface: JollofMakerInterface;
  ...
  functions: {
    ...
    shed(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    shed(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    shed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
